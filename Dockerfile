...
RUN apt-get -y install libglu1-mesa-dev mesa-common-dev mesa-utils libsdl2-2.0-0 libsdl2-dev libsdl-mixer1.2 libsdl-mixer1.2-dev glew-utils libglew-dev libsdl2-net-2.0-0 libsdl2-net-dev 
