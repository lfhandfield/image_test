helloworld: main.o cstructs.o bastructs.o primitive.o display.o glad.o
	g++ -std=c++11 main.o cstructs.o bastructs.o primitive.o display.o glad.o -l SDL2 -l GL -l  SDL2_net -ldl -lpthread -o helloworld
